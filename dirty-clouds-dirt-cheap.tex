...
\begin{frame}[noframenumbering]
    ...
    \titlepage{}
    \centering
    \href{https://github.com/mtreinish/dirty-clouds-done-dirt-cheap/tree/fossasia-2018}{https://github.com/mtreinish/dirty-clouds-done-dirt-cheap/tree/fossasia-2018}
\end{frame}
}
...
\begin{frame}
    ...
    \begin{itemize}
        \item Over 1800 git repositories hosted on: \href{https://git.openstack.org/}{https://git.openstack.org/}
    ...
    \begin{columns}[T]
        \begin{column}{.48\textwidth}
            \begin{itemize}
                ...
                \item \normalsize The install guide mostly concerned with these projects
            \end{itemize}
        \end{column}
        \begin{column}{.48\textwidth}
...
\subsubsection{Requirements issues}
\begin{frame}
...
\begin{frame}
    ...
    \centering
    \includegraphics[width=.65\textwidth]{deploy-lb-provider-overview.png}
\end{frame}

\begin{frame}
    \frametitle{Issues with Neutron}
    \begin{columns}[T]
        \begin{column}{.48\textwidth}
            \begin{itemize}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Using Nova's ConfigDrive works except most versions of cloud-init don't set static IP from config drives
            (Fixed with newer cloud-init, >=0.7.9)
...
\begin{frame}
    ...
    \begin{itemize}
        \item Lots of capacity for running devstack or virtual clouds
   ...
   \Wider[4em]{\usebeamerfont{frametitle}\usebeamercolor[fg]{frametitle}Cloud Native Compute Workloads}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item The power bill (at peak draw it's about 1.35kW for the rack)
...
\frametitle{Where to get more information}
    \begin{itemize}
        ...
        \item Blog post about the project: \href{https://blog.kortar.org/?p=380}{https://blog.kortar.org/?p=380}
        \item These slides: \href{https://github.com/mtreinish/dirty-clouds-done-dirt-cheap/tree/fossasia-2018}{https://github.com/mtreinish/dirty-clouds-done-dirt-cheap/tree/fossasia-2018}
   \end{itemize}
\end{frame}
